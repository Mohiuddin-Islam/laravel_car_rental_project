        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0" style="color:black">All Payment List</h5>
                    <a class="btn btn-warning mt-2" href="{{ route('payment.create') }}">Add Payment</a>
                    @if (session('msg'))
                                    ...
                                    <td>
                                        <form action="{{route('payment.destroy', $item->id)}}" method="POST">
                                            ...
                                            @method('DELETE')
                                                ...
                                                href="{{ route('invoice', $item->id) }}">Print</a>
