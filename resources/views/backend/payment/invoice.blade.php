...
<body>
    <div class="container">
        ...
        <div class="inv-header">
            <div>
                <h2 style="color: #ff9b00">Remons Rent Car</h2>
                <ul>
                    <li>Mohiuddin Islam </li>
                ...
                <ul>
                    ...
                    <li>{{$data->booking->customer->phone}}</li>
                </ul>
            </div>
        </div>
        <div class="inv-body">
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <h4>{{$data->booking->car_list->brand}}</h4>
                        </td>
                        <td>{{$data->booking->car_list->model}}</td>
                        <td>{{$data->booking->pick_up_date}}</td>
                        <td>{{$data->booking->drop_off_date}}</td>
                        <td>{{$data->booking->car_list->price_per_day}}</td>
                    </tr>
        ...
        <h3 style="text-align: center; margin-top: 30px">Thank you for choosing and trusting our car company</h3>
    </div>
    <script>
