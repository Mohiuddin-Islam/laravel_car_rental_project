    ...
    <div class="col-lg-8 offset-2 mt-4">
        <div class="card">
            ...
            <div class="card-header">
                <h5 class="card-title mb-0" style="color:black">Add New Customer</h5>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                <form action="{{route('customer.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEngine" class="form-label">Password</label>
                        <input type="password" name="password" class="form-control" id="exampleInputEmail1" aria-describedby="engineHelp" placeholder="Enter Password">
